...
import { X, Link2, Lock, Copy, Check, Calendar } from "lucide-react";
import { useSharedLinks, type SharedLink } from "@/contexts/SharedLinksContext";
import { useTrack } from "@/contexts/TrackContext";
import { toast } from "sonner";

interface ShareStemsModalProps {
  open: boolean;
  onClose: () => void;
  trackId: number;
}

export function ShareStemsModal({ open, onClose, trackId }: ShareStemsModalProps) {
  ...
  const handleCreate = () => {
    ...
    const newLink: SharedLink = {
      ...
      linkName: linkName.trim() || `${track.title} — Stems`,
      linkType,
          ...
          >
            ...
            <div className="px-6 py-4 border-b border-border">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-semibold text-foreground">Share Stems</h3>
                  <p className="text-xs text-muted-foreground mt-0.5">{track.title} — {track.artist}</p>
                </div>
            ...
            {createdLink ? (
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-secondary/50 border border-border">
                  ...
                  <span className="text-xs font-semibold text-foreground">{track.stems?.length || 0} stems</span>
                </div>
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <button
                    ...
                    disabled={(track.stems?.length || 0) === 0}
