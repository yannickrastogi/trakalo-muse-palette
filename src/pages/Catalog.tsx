                    ...
                    <tbody>
                      {filteredTracks.length === 0 ? (
                        ...
                        filteredTracks.map((track) => (
                          <tr key={track.id} className="border-b border-border last:border-0 hover:bg-secondary/50 transition-colors group/row cursor-pointer" onClick={() => navigate(`/track/${track.id}`)}>
