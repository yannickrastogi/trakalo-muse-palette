...
export default function SettingsPage() {
  return (
    <PageShell>
      <motion.div variants={container} initial="hidden" animate="show" className="p-6 lg:p-8 space-y-6 max-w-[800px]">
        ...
        <div className="space-y-2.5">
          {sections.map((s) => (
            <motion.button
              key={s.title}
              variants={item}
              className="w-full card-premium flex items-center gap-4 p-5 text-left group"
            >
