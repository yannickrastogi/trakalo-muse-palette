    ...
    <PageShell>
      <motion.div variants={container} initial="hidden" animate="show" className="p-6 lg:p-8 space-y-6 max-w-[1400px]">
        <motion.div variants={item}>
          <h1 className="text-2xl font-bold text-foreground tracking-tight">Stems</h1>
          <p className="text-muted-foreground text-sm mt-1">Manage audio stems for your tracks</p>
        </motion.div>

        <motion.div variants={item} className="card-premium flex flex-col items-center justify-center py-24 text-center">
